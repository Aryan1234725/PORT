...
export const SkillsInfo = [
  ...
  export const experiences = [
    ...
    },
    {
      ...
      desc: "Analyzed real-world datasets and created interactive dashboards using SQL,Power BI,Python and Excel",
      skills: [
        "SQL",
        "Power BI",
        "Python",
  ...
  export const education = [
      ...
      
    {
      id: 1,
      img: vpsLogo,
      school: "Nirala College, Nagpur",
      date: "Apr 2019 - March 2021",
      grade: "78%",
      desc: "I completed my class 12 education from Nirala College, Nagpur, under the State board, where I studied Physics, Chemistry, and Mathematics (PCM) with Computer Science.",
      degree: "CBSE(XII) - PCM with Computer Science",
    },
    {
      id: 2,
      img: vpsLogo,
      school: "Lalitha Public School,Nagpur",
      date: "Apr 2006 - March 2018",
      grade: "89.4%",
      desc: "I completed my class 10 education from Lalitha Public School,Nagpur, under the CBSE board, where I studied Science with Computer.",
  ...
  export const projects = [
    {
      ...
      description:
        "A web-based Rock Paper Scissors game built using React JS that allows users to play against the computer. The game features a user-friendly interface, score tracking, and responsive design for an engaging gaming experience.",
      image: Logo,
      tags: ["HTML", "CSS", "JavaScript", "Bootstrap"],
      webapp: "https://aryan1234725.github.io/TIC-TAC-TOE/",
    },
    {
      id: 1,
